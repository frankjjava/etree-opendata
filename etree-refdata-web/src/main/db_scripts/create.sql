CREATE SCHEMA opendata_tbls;

GRANT USAGE ON SCHEMA opendata_tbls TO vdc_user;

GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA opendata_tbls TO vdc_user;

GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA opendata_tbls TO vdc_user;

ALTER DEFAULT PRIVILEGES IN SCHEMA opendata_tbls GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO vdc_user;

ALTER DEFAULT PRIVILEGES IN SCHEMA opendata_tbls GRANT USAGE, SELECT, UPDATE ON SEQUENCES TO vdc_user;
